...
router.route('/').get(getCourses).post(addCourse); // the :/bootcampId/courses route will fire here because it was a GET route, even though the course route used on this same line of code is '/'. It will just fire the controller method necessary for the GET method
